...
data class RecentMediaSize(override val width: Float, override val height: Float) : Size {
...
data class RecentTrimSize(override val width: Float, override val height: Float) : Size {
    @PrimaryKey(autoGenerate = true)
    var id: Long = 0
}
